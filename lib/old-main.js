...
const JSONVIEW_NATIVE_JSONVIEW_PREF_NAME = "useNativeJsonView";
const DEVTOOLS_NATIVE_JSONVIEW_PREF_NAME = "devtools.jsonview.enabled";
...
function nativeJsonviewChanged(prefName) {
  // Tie the native JSONView enablement to our pref
  prefsService.set(DEVTOOLS_NATIVE_JSONVIEW_PREF_NAME,
                   prefs.prefs[JSONVIEW_NATIVE_JSONVIEW_PREF_NAME]);
}
...
function onLoad(options, callbacks) {
  ...
  prefs.on(JSONVIEW_NATIVE_JSONVIEW_PREF_NAME, nativeJsonviewChanged);
  nativeJsonviewChanged(JSONVIEW_NATIVE_JSONVIEW_PREF_NAME);
