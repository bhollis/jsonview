...
JSONFormatter.prototype = {
  ...
  arrayToHTML: function(json, path) {
    ...
    return (json.length !== 0 ? '<span class="collapser"></span>' : '') + '[ <span class="counter">' + json.length + '</span> <ul class="array collapsible">' + output + '</ul>]';
  },
  ...
  objectToHTML: function(json, path) {
    ...
    return '<span class="collapser"></span>{ <span class="counter">' + Object.keys(json).length + '</span> <ul class="obj collapsible">' + output + '</ul>}';
  },
